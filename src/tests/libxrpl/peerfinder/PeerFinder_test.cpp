...
TEST(PeerFinderConfig, AppliesLegacyAndExplicitPeerLimits)
{
    ...
    std::vector<ConfigCase> const cases{
        {.name="legacy no config", .maxPeers={}, .maxIn={}, .maxOut={}, .port=4000, .expectedOut=10, .expectedIn=11, .expectedIpLimit=2},
        {.name="legacy max_peers 0", .maxPeers=0, .maxIn=100, .maxOut=10, .port=4000, .expectedOut=10, .expectedIn=11, .expectedIpLimit=2},
        {.name="legacy max_peers 5", .maxPeers=5, .maxIn=100, .maxOut=10, .port=4000, .expectedOut=10, .expectedIn=0, .expectedIpLimit=1},
        {.name="legacy max_peers 20", .maxPeers=20, .maxIn=100, .maxOut=10, .port=4000, .expectedOut=10, .expectedIn=10, .expectedIpLimit=2},
        {.name="legacy max_peers 100", .maxPeers=100, .maxIn=100, .maxOut=10, .port=4000, .expectedOut=15, .expectedIn=85, .expectedIpLimit=6},
        {.name="legacy max_peers 20, private", .maxPeers=20, .maxIn=100, .maxOut=10, .port=0, .expectedOut=20, .expectedIn=0, .expectedIpLimit=1},
        {.name="new in 100/out 10", .maxPeers={}, .maxIn=100, .maxOut=10, .port=4000, .expectedOut=10, .expectedIn=100, .expectedIpLimit=6},
        {.name="new in 0/out 10", .maxPeers={}, .maxIn=0, .maxOut=10, .port=4000, .expectedOut=10, .expectedIn=0, .expectedIpLimit=1},
        {.name="new in 100/out 10, private", .maxPeers={}, .maxIn=100, .maxOut=10, .port=0, .expectedOut=10, .expectedIn=0, .expectedIpLimit=6}};
